...
import com.cheetahlou.careu.chat.Login1Activity;
...
//                ivstart2.invalidate();
        ...
        launch.postDelayed(new Runlaunch(),1250);//设置2.5秒钟延迟执行Runlaunch线程，
    }
//两张图片Alpha值渐变函数
...
/*        //第二张图片的Alpha变化，渐渐从透明变成完全不透明
    ...
    class Runlaunch implements Runnable{
        ...
        public void run() {
            ...
            if(isLogin){
                startActivity(new Intent(LaunchActivity.this,Login1Activity.class));
            }else{
